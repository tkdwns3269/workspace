...
SELECT * FROM EMPT_TABLE;

--1_2) 컬럼 수정(MODIFY)
--데이터 타입 수정 : MODIFY 컬럼명 바꾸고자하는 데이터타입
-- DEFAULT값 수정 : MODIFY 컬럼명 DEFAULT
...
ALTER TABLE DEPT_COPY DROP COLUMN LANEME;
...
----------------------------------------------------------------------------
--3) 컬럼명 / 제약조건명 / 테이블명 변경
--3_1) 컬럼명 변경 : RNAME COLUMN 기존컬러명 TO 바꿀 컬럼명
...
--3_2) 제약조건명 변경: RENAME CONSTRAINT 기존제약 조건명  TO 바꿀제약조건명
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C007151 TO DTABLE_IN_NN;
