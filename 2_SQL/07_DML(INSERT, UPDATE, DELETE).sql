...
SELECT * FROM EMP_01;
INSERT INTO EMP_01( SELECT EMP_ID, EMP_NAME, EMP_NO
                                    FROM EMPLOYEE
...
/*
        [표현식]
        INSERT ALL
        INTO 테이블명 1  VALUES (컬럼, 컬럼, 컬럼,  ....)
        INTO 테이블명 2  VALUES (컬럼, 컬럼, 컬럼,  ....)
        서브쿼리
*/
...
--전체사원의 급여를 기존 급여에 10프로 인상된 가격으로 변경
UPDATE EMP_SALARY
...
--방명수 사원의 급여와 보너스값을 유재식 사원의 급여와 보너스로 변경
UPDATE EMP_SALARY
...
--ASIA 지역에서 근무하는 사원들(EMP_ID, EMP_NAME)
